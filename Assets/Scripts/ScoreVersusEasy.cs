...
public class ScoreVersusEasy : MonoBehaviour
{
    ...
    {
        if (scoreToCheck > PlayerPrefs.GetInt("Easy VS High Score", 0))
        {
            PlayerPrefs.SetInt("Easy VS High Score", scoreToCheck);
            UpdateHighScore();
        }
    }
    ...
    {
        highScoreText.text = "EASY VS HIGH SCORE: " + PlayerPrefs.GetInt("Easy VS High Score", 0).ToString();
    }
}
