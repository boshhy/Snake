...
public class ScoreTwoPlayersEasy : MonoBehaviour
{
    ...
    void CheckHighScore()
    {
        if (foodCount > PlayerPrefs.GetInt("Easy Co-op High Score", 0))
        {
            PlayerPrefs.SetInt("Easy Co-op High Score", foodCount);
            UpdateHighScore();
        }
    }
    ...
    {
        highScoreText.text = "EASY CO-OP HIGH SCORE: " + PlayerPrefs.GetInt("Easy Co-op High Score", 0).ToString();
    }
}
