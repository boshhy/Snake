...
public class ScoreVersusHard : MonoBehaviour
{
    ...
    {
        if (scoreToCheck > PlayerPrefs.GetInt("Hard VS High Score", 0))
        {
            PlayerPrefs.SetInt("Hard VS High Score", scoreToCheck);
            UpdateHighScore();
        }
    }
    ...
    {
        highScoreText.text = "HARD VS HIGH SCORE: " + PlayerPrefs.GetInt("Hard VS High Score", 0).ToString();
    }
}
